    ...
    questions: [
      {
        ...
        prompt: "관측가능(x) => ?",
        answer: "분리(관측자, 대상)",
        actionText: "resolve the separation binding required by observable(x).",
        idleText: "observable(x) requires observer-target separation.",
      },
      {
        id: "Q1-2",
        prompt: "관측(자기, 자기) ∧ ¬분리(관측자, 대상) => ?",
        answer: "¬정의(자기, 자기)",
        actionText: "resolve the self-observation failure clause.",
        idleText: "self-observation plus failed separation collapses self-definition.",
      },
    ],
    outputText: [
      "관측가능(x) := 분리(관측자, 대상)",
