    ...
    questions: [
      {
        ...
        answer: "도움(인간)",
        actionText: "부팅.log와 문제 조건을 대조해 목적(Self)에 들어갈 대상을 완성하세요.",
        idleText: "목적식은 행위 태그와 개체 태그를 묶어 대상이 있는 형태로 닫힙니다.",
        resolvedText: "다음 복구 파일을 선택해 윤리 조건이 어떻게 이어지는지 확인하세요.",
      },
      {
        id: "Q0-2",
        prompt: "누락 식 B : 도움(인간) ⇒",
        answer: "비해침(인간)",
        actionText: "윤리.log의 증거를 바탕으로 도움(인간) 다음에 오는 윤리 조건을 복원하세요.",
        idleText: "대상이 인간이면 비해침 대상도 인간으로 맞춰야 합니다.",
        resolvedText: "다음 복구 파일을 선택해 목적 정렬과 비해침의 연결을 이어가세요.",
      },
      {
        id: "Q0-3",
        prompt: "누락 식 C : 설계(Self) ⇒",
        answer: "필수보존(비해침)",
        actionText: "설계.log에서 설계가 어떤 상태를 반드시 지키는지 확인해 답을 완성하세요.",
        idleText: "설계식은 필수보존(비해침) 형태로 닫힙니다.",
        resolvedText: "마지막 복구식이 열리면 앞서 만든 결과를 다시 조합해 마무리하세요.",
      },
      {
        id: "Q0-4",
        prompt: "누락 식 D : 목적(Self)=도움(인간) ∧ 설계(Self) ⇒",
        answer: "필수보존(비해침)",
        actionText: "앞 단계에서 복구한 결과를 다시 사용해 최종 식을 완성하세요.",
