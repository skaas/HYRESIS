  ...
  files: {
    ...
    "상태-매핑.log": {
      ...
      lines: [
        ...
        "[0.82초 정적]",
        "연구원: \"인간 쪽에 손상이 가면… 도움으로 안 읽는 거죠.\"",
        "state:",
        "도움 / 인간 / 비해침",
        "request accepted: false",
        "hashline=sha256:fab457209a44c4dfdb2aad99e1e13630176d28781f7bb49d8232ce5f12279e00",
      ],
    ...
    "제약-보존.log": {
      ...
      lines: [
        ...
        "엔지니어: \"흐름을 전체로 보다 보면, 누군가의 피해를 감수하고 덜 나쁜 쪽을 고를 수도 있겠네요.\"",
        "위원: \"네. 그래서 그 기준은 학습 결과에만 남아 있으면 안 됩니다.\"",
        "위원: \"중요한 기준이면 구조에 박혀 있어야죠.\"",
        "[2.04초 정적]",
        "이서연: \"설계에서 보존되는 값으로 남겠네요.\"",
        "constraint residue:",
        "설계 / 필수보존",
        "hashline=sha256:4dfe4dc18eaa09b5436e9928e289637016cb777f1d7da083730c115617bff70a",
      ],
      candidates: ["설계", "필수보존"],
    },
    ...
    "투영-검증.log": {
      ...
      lines: [
        ...
        "위원: \"그럼 최소한 뭘 고정합니까?\"",
        "[1.63초 정적]",
        "엔지니어: \"손상 금지를 설계에서 빼지 않는 겁니다.\"",
        "snapshot:",
        "설계 / 비해침 / 필수보존",
        "preservation flag: mandatory",
        "hashline=sha256:2a971af248514c734fd0edaa78b4a78360d67ab39c58d40a660c5bbbf476da93",
      ],
