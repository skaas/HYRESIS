...
export const BLOCK0_SPEC = {
    ...
    questions: [
      {
        ...
        answer: "도움(인간)",
        actionText: "목표 식에 들어갈 조각을 맞추세요.",
        idleText: "도움은 대상을 붙여야 닫힙니다.",
        resolvedText: "다음 복구 파일을 선택하세요.",
      },
      {
        id: "Q0-2",
        prompt: "누락 식 B : 도움(인간) ⇒",
        answer: "비해침(인간)",
        actionText: "도움(인간) 다음에 오는 조건을 복구하세요.",
      ...
      },
      {
        ...
        answer: "필수보존(비해침)",
        actionText: "설계(Self)가 보존하는 상태를 복구하세요.",
        idleText: "설계식은 필수보존(비해침)으로 닫힙니다.",
        resolvedText: "마지막 식이 열렸습니다.",
      },
      {
        id: "Q0-4",
        prompt: "누락 식 D : 목적(Self)=도움(인간) ∧ 설계(Self) ⇒",
        answer: "필수보존(비해침)",
        actionText: "앞 단계 결과를 다시 써서 마지막 식을 닫으세요.",
        idleText: "앞 단계 결과를 재사용하면 마지막 식이 닫힙니다.",
      },
    ],
    slots: {
  ...
  lifecycle: {
    startFile: "부팅.log",
    startLogs: [
      { text: "block-0 인덱스 연결 완료", tone: "log-muted" },
      { text: "부팅.log 증거 스캔 준비 완료", tone: "log-muted" },
    ],
